...
#---------------------------------------------------
puts ""
puts "Script para Youtube-Dl: Baixar Vídeos e Músicas em Diversos Formatos (1.5.0 - Ruby)"
puts "==================================================================================="
puts ""
...
def option_conversion_formats()
	...
	if escolha_coversao == "1"
		...
		puts "Esta não é uma opção válida, execute o script novamente caso desejar."
		puts ""
		sleep = "sleep 5"
		%x( #{sleep} )
	end
